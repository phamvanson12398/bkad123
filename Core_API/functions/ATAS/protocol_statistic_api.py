...
class ATASProtocolDataStatisticCollectionAPI(Resource):
...
class ATASAddressDataStatisticCollectionAPI(Resource):
...
class ATASOthersDataStatisticCollectionAPI(Resource):
