...
class ATASMethodDataStatisticCollectionAPI(Resource):
...
class ATASUrlDataStatisticCollectionAPI(Resource):
...
class ATASCookieDataStatisticCollectionAPI(Resource):
...
class ATASAgentDataStatisticCollectionAPI(Resource):
...
class ATASHostDataStatisticCollectionAPI(Resource):
